...
rec {
  ...
  test =
    assert example1Branch.onPush.default.outputs.checks.release-artifacts.files == expectedFiles;
    assert example1Tag.onPush.default.outputs.checks.release-artifacts.files == expectedFiles;

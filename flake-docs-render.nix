{
  perSystem =
    ...
    in
    {
      packages.generated-option-doc-modularEffect = renderModule {
        sourceName = "effect";
        sourcePath = ./effects/effect;
        modules = [ ];
      };

      packages.generated-option-doc-gitWriteBranch = renderModule {
        sourceName = "write-branch";
        sourcePath = ./effects/write-branch;
        modules = [ ./effects/write-branch/effect-module.nix ];
      };

      packages.generated-option-doc-git-auth = renderModule {
        sourceName = "git-auth";
        sourcePath = ./effects/modules/git-auth.nix;
        modules = [ ./effects/modules/git-auth.nix ];
      };

      packages.generated-option-doc-git-update = renderModule {
        sourceName = "git-auth";

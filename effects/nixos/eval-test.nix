...
rec {
    ...
    flake-parts.lib.mkFlake { inherit inputs; } (
      { withSystem, self, ... }:
      {
        ...
        flake = {
          ...
          test.by-nixosConfigurations = withSystem "x86_64-linux" (
            { hci-effects, ... }:
          ...
          test.by-configuration-file = withSystem "x86_64-linux" (
            { hci-effects, ... }:
            hci-effects.runNixOS {
              ssh.destination = "john.local";
          ...
          test.by-configuration-file-buildOnDestination = withSystem "x86_64-linux" (
            { hci-effects, ... }:
            hci-effects.runNixOS {
              ssh.destination = "john.local";
          ...
          test.by-nixosConfigurations-no-buildOnDestination = withSystem "x86_64-linux" (
            { hci-effects, ... }:
            hci-effects.runNixOS {
              ssh.destination = "john.local";
          ...
          test.by-nixosConfigurations-buildOnDestination = withSystem "x86_64-linux" (
            { hci-effects, ... }:
            hci-effects.runNixOS {
              ssh.destination = "john.local";
              ssh.buildOnDestination = true;
          ...
          test.by-nixosConfigurations-buildOnDestination-override = withSystem "x86_64-linux" (
            { hci-effects, ... }:
            hci-effects.runNixOS {
              ssh.destination = "john.local";
              ssh.buildOnDestination = false;
  ...
  tests =
    ...
    assert isEffect flake1.test.by-nixosConfigurations;
    assert testEqDrv flake1.test.by-nixosConfigurations.drvPath
      flake1.test.by-nixosConfigurations-no-buildOnDestination.drvPath;
    assert isEffect flake1.test.by-configuration-file;
    assert isEffect flake1.test.by-configuration-file-buildOnDestination;
    assert testEqDrv flake1.test.by-nixosConfigurations-buildOnDestination.drvPath
